...
public class WIFIIpDhcpSettingController extends BaseController implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
                ...
                if(rtPrinter != null && rtPrinter.getConnectState() == ConnectStateEnum.Connected){
                    if (DHCP_STATE == 0x00) {//DHCP disable
                        ...
                        if ((ip_length == 4) && (mask_length == 4) && (gateway_length == 4)){
                            ...
                            ToastController.show(WIFIIpDhcpSettingController.this, "Please input correct ip,sub_mask or gateway.");
                        }
