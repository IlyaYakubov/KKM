...
public class ScrollEditTextController extends android.support.v7.widget.AppCompatEditText {

    private GestureDetector detector;

    public ScrollEditTextController(Context context, AttributeSet attrs) {
        super(context, attrs);
