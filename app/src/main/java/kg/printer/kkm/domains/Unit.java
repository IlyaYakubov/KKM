...
public class Unit extends BaseController implements View.OnClickListener, LocalDataBaseDAO {
        ...
        switch (view.getId()) {
            case R.id.btn_ok:
                if (et_name.getText().toString().isEmpty()) {
                    ToastController.show(this, "Заполните наименование единицы измерения");
                } else {
                    addData();
                    hideKeyboard(view);
                    finish();
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) Unit.this.getSystemService(BaseController.INPUT_METHOD_SERVICE);
