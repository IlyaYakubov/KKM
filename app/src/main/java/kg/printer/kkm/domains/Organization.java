...
public class Organization extends BaseController implements View.OnClickListener, LocalDataBaseDAO {
        ...
        switch (view.getId()) {
            case R.id.btn_ok:
                if (et_org_name.getText().toString().isEmpty()) {
                    ToastController.show(this, "Заполните название организации");
                } else if (et_magazine_name.getText().toString().isEmpty()) {
                    ToastController.show(this, "Заполните название торговой точки");
                } else if (et_adress_magazine.getText().toString().isEmpty()) {
                    ToastController.show(this, "Заполните адрес торговой точки");
                } else if (et_telephone_magazine.getText().toString().isEmpty()) {
                    ToastController.show(this, "Заполните контактный телефон");
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) Organization.this.getSystemService(BaseController.INPUT_METHOD_SERVICE);
