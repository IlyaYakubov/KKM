...
public class Administrator extends BaseController implements View.OnClickListener, LocalDataBaseDAO {
    ...
    private BasicPassController settingPasswordDialog;
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) Administrator.this.getSystemService(BaseController.INPUT_METHOD_SERVICE);
