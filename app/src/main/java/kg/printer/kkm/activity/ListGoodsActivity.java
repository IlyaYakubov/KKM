...
import kg.printer.kkm.activity.subjects.GoodActivity;
...
public class ListGoodsActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_add:
                turnToActivityWithPosition(GoodActivity.class, -1, 1);
                break;
            default:
                break;
        }
    ...
    public void readData() {
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                turnToActivityWithPosition(GoodActivity.class, position, 0);
            }
        });
