...
public class UnitActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_unit);
        ...
        switch (view.getId()) {
            case R.id.btn_ok:
                if (et_name.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните наименование единицы измерения");
                } else {
                    addData();
                    hideKeyboard(view);
                    finish();
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) UnitActivity.this.getSystemService(BaseActivity.INPUT_METHOD_SERVICE);
