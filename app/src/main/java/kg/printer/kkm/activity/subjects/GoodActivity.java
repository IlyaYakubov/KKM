...
public class GoodActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
        ...
        switch (view.getId()) {
            case R.id.btn_ok:
                if (et_name.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните наименование товара");
                } else {
                    addData();
                    hideKeyboard(view);
                    finish();
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) GoodActivity.this.getSystemService(BaseActivity.INPUT_METHOD_SERVICE);
