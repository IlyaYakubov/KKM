...
public class UserActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
    ...
    public BaseData dbHelper;

    public BasicPassDialog settingPasswordDialog;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_del_user:
                deleteData();
                ToastUtil.show(this, "Пользователь удалён");
                hideKeyboard(view);
                finish();
                break;
            case R.id.btn_ok:
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) UserActivity.this.getSystemService(BaseActivity.INPUT_METHOD_SERVICE);
