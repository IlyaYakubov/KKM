...
import kg.printer.kkm.view.BasicPassDialog;

public class AdministratorActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
    ...
    private BasicPassDialog settingPasswordDialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_u_administrator);
    ...
    public void init() {
        ...
        settingPasswordDialog = new BasicPassDialog();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_del_pass:
                ...
                ToastUtil.show(this, "Пароль удалён");
                break;
            case R.id.btn_ok:
                if (et_position.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните должность");
                } else if (et_surname.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните фамилию");
                } else if (et_name.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните имя");
                } else if (et_second_name.getText().toString().isEmpty()) {
                    ToastUtil.show(this, "Заполните отчество");
                } else {
                    updateData();
                    hideKeyboard(view);
                    finish();
    ...
    private void hideKeyboard(View view) {
        ...
        if (viewLayout != null) {
            InputMethodManager inputMethodManager = (InputMethodManager) AdministratorActivity.this.getSystemService(BaseActivity.INPUT_METHOD_SERVICE);
