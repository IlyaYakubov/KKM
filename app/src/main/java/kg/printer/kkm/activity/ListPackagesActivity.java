...
import kg.printer.kkm.activity.subjects.SetPackageActivity;
import kg.printer.kkm.utils.BaseData;
import kg.printer.kkm.utils.LocalDataBase;

import java.util.ArrayList;

public class ListPackagesActivity extends BaseActivity implements View.OnClickListener, LocalDataBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pa_list_packages);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_add:
                turnToActivityWithPosition(SetPackageActivity.class, -1, 1);
                break;
            default:
                break;
        }
    ...
    public void readData() {
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                turnToActivityWithPosition(SetPackageActivity.class, position, 0);
            }
        });
