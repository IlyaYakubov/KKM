...
import kg.printer.kkm.view.FlowRadioGroup;

public class PrinterActivity extends BaseActivity implements View.OnClickListener, PrinterObserver {
    ...
    private void showConnectDialog() {
        switch (checkedConType) {
            case BaseEnum.CON_COM:
                ToastUtil.show(PrinterActivity.this, "Нажмите на [Подключиться] чтобы установить соединение");
                break;
            default:
                break;
        }
